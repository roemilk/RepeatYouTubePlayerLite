...
import com.venuskimblessing.tuberepeatfree.Utils.OSUtils;
...
public class DialogHelp extends Dialog implements View.OnClickListener {
    ...
    private void init(){
        ...
        mInstagramButton = (Button)findViewById(R.id.help_send_email_button);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.help_facebook_button:
                ...
                mContext.startActivity(intent);
                break;
            case R.id.help_send_email_button:
