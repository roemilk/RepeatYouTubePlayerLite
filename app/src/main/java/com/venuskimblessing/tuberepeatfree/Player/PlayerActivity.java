...
package com.venuskimblessing.tuberepeatfree.Player;
...
import com.venuskimblessing.tuberepeatfree.FloatingView.FloatingService;
import com.venuskimblessing.tuberepeatfree.Json.PlayingData;
import com.venuskimblessing.tuberepeatfree.Json.Videos;
import com.venuskimblessing.tuberepeatfree.LoadingActivity;
    ...
    private void shareFacebook() {
        ...
        if (ShareDialog.canShow(ShareLinkContent.class)) {
            ...
            ShareLinkContent linkContent = new ShareLinkContent.Builder()
                    .setContentUrl(Uri.parse("https://play.google.com/store/apps/details?id=com.venuskimblessing.tuberepeatfree"))
